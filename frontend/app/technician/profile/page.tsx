...
import { User, Mail, Phone, Shield, Bell, Save, FileText, Calendar, Clock, Loader2, AlertCircle } from "lucide-react"
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      try {
        ...
        // In a real app, you would fetch this from an activity log API
        setActivities([
          {
          ...
          },
          {
            ...
            date: formatDate(user.lastLogin) || "N/A",
